...
void system_init(void)
{
	...
	gpio_set_pin_level(CAN0_SILENT,
	                   // <y> Initial level
	...
	gpio_set_pin_direction(CAN0_SILENT, GPIO_DIRECTION_OUT);

	gpio_set_pin_function(CAN0_SILENT, GPIO_PIN_FUNCTION_OFF);

	/* GPIO on PE2 */

	gpio_set_pin_level(CAN1_SILENT,
	                   // <y> Initial level
	                   // <id> pad_initial_level
	                   // <false"> Low
	                   // <true"> High
